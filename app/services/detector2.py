...
# Cambia a yolov8n.pt
MODELO_PATH = "yolov8n.pt"  # 👈 Modelo estándar
VIDEO_PATH = "ml/videos/ejem4.mp4"

modelo = YOLO(MODELO_PATH)
cap = cv2.VideoCapture(VIDEO_PATH)

# ─── UMBRALES ────────────────────────────────────────────────
CONFIANZA_MIN = 0.4  # Un poco más alto para mejor precisión
...
while True:
    ...
    for box in resultados[0].boxes:
        ...
        # yolov8n: clase 0 = persona, clase 3 = moto
        ...
        elif clase == 0:  # person (yolov8n usa clase 0, no 4)
